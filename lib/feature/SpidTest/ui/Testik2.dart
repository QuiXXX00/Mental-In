...
class PsychologicalAgeTestScreen extends StatefulWidget {
  ...
  _PsychologicalAgeTestScreenState createState() => _PsychologicalAgeTestScreenState();
}

class _PsychologicalAgeTestScreenState extends State<PsychologicalAgeTestScreen> {
  ...
  String calculatePsychologicalAge(Map<int, String> answers) {
    ...
    if (countA > countB && countA > countC) {
      ...
      return countB > (totalQuestionsCount * 0.9) ? 'Прелестный малыш: Чистое и невинное существо, прелестный малыш олицетворяет радость и чудо в мире. Он или она полны любопытства, энергии и радости, ищут защиты и заботы от окружающих.'
      ...
      return countC > (totalQuestionsCount * 0.9) ? 'Суперстар: Излучая магнетизм и обаяние, суперстар привлекает внимание и восхищение окружающих. Он или она обладают уверенностью и талантом, стремясь к достижению выдающихся результатов в своей области.'
...
List<Map<String, dynamic>> psychologicalAgeQuestions = [
  {
    ...
    'options': ['А. Честно говоря, мне есть по поводу чего комплексовать (у меня достаточно много несовершенств).', 'Б. Чаще нет.', 'В. Да, я смирилась со своими недостатками.']
  },
  {
    'question': 'Вам нравится ваша работа?',
    'options': ['А. Мне нравится то, чем я занимаюсь.', 'Б. Не люблю работать.', 'В. Не всегда, но бывают моменты, когда очень нравится (такое случается редко).']
  },
  {
    'question': 'Если у вас что-нибудь получается:',
    'options': ['А. У вас повышается самооценка.', 'Б. Вы испытываете удивление и радость.', 'В. Для вас это само собой разумеющийся факт.']
  },
  {
    'question': 'Если вам надо срочно решить серьезный деловой вопрос, вы:',
    'options': ['А. Стараетесь решить его самостоятельно в сжатые сроки.', 'Б. Просите помощи у других или перекладываете ответственность на чужие плечи.', 'В. Откладываете его решение ненадолго, чтобы прийти к правильным выводам и выработать дальнейшую тактику ведения дела.']
  },
  {
    'question': 'Вы получаете очень хорошее известие. В первый момент вы:',
    'options': ['А. Делаете вид, что для вас это не важно.', 'Б. Не можете в это поверить.', 'В. Чувство радости переполняет вас.']
  },
  {
    'question': 'Часто ли вы вините себя в жизненных провалах?',
    'options': ['А. Редко.', 'Б. Во всех моих бедах виноваты жизненные обстоятельства, иногда окружающие, только не я сам.', 'В. Бывает иногда.']
  },
  {
    'question': 'Когда вы получаете зарплату, вы:',
    'options': ['А. Идете по магазинам.', 'Б. Раздаете долги.', 'В. Откладываете сразу часть денег на счет, который ежемесячно пополняете.']
  },
  {
    'question': 'Заболев хроническим недугом, вы:',
    'options': ['А. Сами стараетесь сделать все для выздоровления.', 'Б. Вас это мало беспокоит, оставляете все, как есть.', 'В. Ходите по врачам и аптекам.']
  },
  {
    'question': 'Какая фраза вам ближе?',
    'options': ['А. Все хорошо, что хорошо кончается.', 'Б. Принять все, как есть.', 'В. Все, что ни делается, к лучшему.']
  },
  {
    'question': 'У вас есть мечта?',
    'options': ['А. Я предпочитаю строить планы на жизнь, а не витать в облаках.', 'Б. Да, я люблю мечтать.', 'В. Нет. Все, о чем мечтал, уже реализовано.']
  },
];
